...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__politics__ = __webpack_require__(277);
...
var PoliticsPage = /** @class */ (function () {
    ...
    PoliticsPage.prototype.navHome = function () {
    ...
    PoliticsPage.prototype.Transacciones = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.Retrasos = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.DirClave = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.Crypto = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.smsText = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.infoPrerequisito = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.actividadesProhibidas = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.cuentasSuspendidas = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.cuentasEliminadas = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.descargoGarantias = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.sinConsejos = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.indemnizacion = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.limiResponsabilidad = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.separabilidad = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.arbAplicable = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.limitaciones = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.propiedadNReclamada = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.acuerdoCompleto = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.politicaPrivacidad = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.comEmail = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.enlServicios = function () {
        var toast = this.toastCtrl.create({
    ...
    PoliticsPage.prototype.camPolitica = function () {
        var toast = this.toastCtrl.create({
